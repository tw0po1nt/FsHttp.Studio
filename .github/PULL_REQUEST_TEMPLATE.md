...
<!--
Required when the diff touches `src/renderer/`, `src/webview/`, or `src/host/ResponseViewer.fs`,
or when it changes a CodeLens title, a notification, a status bar item, or an icon.
...
<!-- The checks that ran, and the checks that a later ticket owns. -->
